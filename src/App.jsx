...
function CourseBuilder({ organization, courses, modules, lessons, onSaved, onArchived }) {
  ...
  const [lessonForm, setLessonForm] = useState({ module_id: "", title: "", description: "", lesson_type: "reading", duration_minutes: "", resource_url: "", content: "" });
  const [status, setStatus] = useState("idle");
