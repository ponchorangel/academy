...
function AdminView({ context, sessions, downloads, events, courses, facilitators, members, invitations, onContentSaved, onOrganizationSaved, onArchived, onMemberChanged, onInvitationCreated }) {
